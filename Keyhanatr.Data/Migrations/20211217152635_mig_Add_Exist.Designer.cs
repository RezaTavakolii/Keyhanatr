...
namespace Keyhanatr.Data.Migrations
{
    ...
    [Migration("20211217152635_mig_Add_Exist")]
    partial class mig_Add_Exist
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Keyhanatr.Data.Domain.Products.ProductExist", b =>
                {
                    b.Property<int>("ExistId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<int>("ExistNumber")
                        .HasColumnType("int");

                    b.HasKey("ExistId");

                    b.ToTable("ProductExist");
                });
            ...
            modelBuilder.Entity("Keyhanatr.Data.Domain.Products.Product", b =>
                {
                    b.HasOne("Keyhanatr.Data.Domain.Products.ProductExist", "ProductExist")
                        .WithMany("Products")
                        .HasForeignKey("ExistId")
